...
::set secondary attack sequences
set secondary_attack_sequence_1=none
set secondary_attack_sequence_2=none
set secondary_attack_sequence_3=none
set secondary_attack_sequence_4=none
::set secondary attack smds
set secondary_attack_smd_1=none
set secondary_attack_smd_2=none
set secondary_attack_smd_3=none
set secondary_attack_smd_4=none
